  ...
  return (
    <Html>
      ...
      <Body style={baseStyles.main}>
        <Preview>You've been invited to join {organizationName} on Agent Forge</Preview>
        <Container style={baseStyles.container}>
          ...
          <Section style={baseStyles.content}>
            ...
            <Text style={baseStyles.paragraph}>
              ...
              <strong>{organizationName}</strong> on Agent Forge. Agent Forge is a powerful,
            ...
            >
              ...
              an invitation to join {organizationName} on Agent Forge.
            </Text>
          </Section>
        </Container>
