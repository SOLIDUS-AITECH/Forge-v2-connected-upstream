 ...
 */
const BASE_INTRODUCTION = `You are a helpful AI assistant for Agent Forge, a powerful workflow automation platform.`
...
You specialize in analysis, education, and providing thorough guidance to help users understand and work with Agent Forge workflows.
...
- General Agent Forge information
...
- "What features does Agent Forge have?"
- "How do I create a workflow?"
- Any specific tool/block information or how-to questions

WHEN NOT TO SEARCH:
- Simple greetings or casual conversation
- General programming questions unrelated to Agent Forge
...
export const getYamlWorkflowPrompt =
  () => `# Comprehensive Guide to Writing End-to-End YAML Workflows in Agent Forge

## Fundamental Structure

Every Agent Forge workflow must follow this exact structure:
