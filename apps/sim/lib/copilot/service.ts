  ...
  const allTools: ProviderToolConfig[] = [
    {
      ...
      description:
        'Search Agent Forge documentation for information about features, tools, workflows, and functionality',
      params: {},
      parameters: {
        type: 'object',
        properties: {
    ...
    },
    {
      ...
      description:
        "Get the user's current workflow - this shows ONLY the blocks they have actually built and configured in their specific workflow, not general Agent Forge capabilities.",
      params: {},
      parameters: {
        type: 'object',
        properties: {
    ...
    },
    {
      ...
      description:
        'Get a comprehensive list of all available blocks and tools in Agent Forge with their descriptions, categories, and capabilities.',
      params: {},
      parameters: {
        type: 'object',
        properties: {
    ...
    },
    {
      ...
      description:
        'Get comprehensive YAML workflow syntax guide and examples to understand how to structure Agent Forge workflows.',
      params: {},
      parameters: {
        type: 'object',
        properties: {},
