...
export async function POST(request: NextRequest) {
  try {
    ...
    const response: any = {
      ...
      note: 'This data represents only the blocks and configurations that the user has actually built in their current workflow, not all available Agent Forge capabilities.',
      yaml,
      format: 'yaml',
      summary: {
