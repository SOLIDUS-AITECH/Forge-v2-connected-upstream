  ...
  const renderActionUI = () => {
    ...
    return (
      <Button
        ...
        className='animate-fade-in items-center bg-[#107e38] px-7 py-6 font-[420] font-geist-sans text-lg text-neutral-100 tracking-normal shadow-[#107e38]/30 shadow-lg hover:bg-[#0e5628]'
