            ...
            <div className='px-6 pb-6'>
              ...
              <div className='mb-4 flex items-center justify-between pt-1'>
                ...
                <Button
                  disabled
                  size='sm'
                  className='flex items-center gap-1 bg-[#107e38] font-[480] text-primary-foreground shadow-[0_0_0_0_#107e38] transition-all duration-200 hover:bg-[#0e5628] hover:shadow-[0_0_0_4px_rgba(127,47,255,0.15)] disabled:opacity-50'
                >
