            ...
            <ScrollArea className="h-full pb-2" hideScrollbar={true}>
              <div className="flex flex-col gap-2">
                {messages.map((msg) => (
                  ...
                  >
                    <div
                      className={`rounded-xl px-4 py-2 max-w-[70%] break-words text-white ${
                        msg.role === "user"
                          ? "bg-[#0e5628]"
                          : "bg-[#222] border border-[#0e5628]"
                      }`}
                      style={msg.role === "assistant" ? { whiteSpace: "pre-line" } : {}}
                    >
                      {msg.content}
                    </div>
                  </div>
                ...
                {loading && (
                  <div className="flex justify-start">
                    <div className="rounded-xl px-4 py-2 max-w-[70%] break-words text-white bg-[#222] border border-[#0e5628] opacity-70">
                      ...
                    </div>
                  </div>
                )}
