...
const examplePayload = JSON.stringify(
  {
    content: 'Hello from Agent Forge!',
  ...
  return (
    <div className='space-y-4'>
      ...
      <InstructionsSection title='Sending Messages to Discord (Outgoing via this URL)'>
        <p>
          To send messages <i>to</i> Discord using the Agent Forge Webhook URL (above), make a POST
      ...
      <Alert>
        ...
        <AlertDescription>
          The Agent Forge Webhook URL allows sending messages <i>to</i> Discord. Treat it like a
