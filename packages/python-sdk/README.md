...
The official Python SDK for [Agent Forge](https://simstudio.ai), allowing you to execute workflows programmatically from your Python applications.
...
- `api_key` (str): Your Agent Forge API key
- `base_url` (str, optional): Base URL for the Agent Forge API (defaults to `https://simstudio.ai`)
